...
SELECT id, name, email, password_hash, role, organization_name, created_at FROM users WHERE email = $1
`
...
SELECT id, name, email, password_hash, role, organization_name, created_at FROM users WHERE id = $1
`
